...
fn test_ws_order() raises:
    ...
    while True:
        ...
        order.symbol = str(obj.get_str_ref("contract"))
        order.status = str(obj.get_str_ref("status"))
        ...
        order.clientOrderId = str(obj.get_str_ref("text"))
        order.timeInForce = str(obj.get_str_ref("tif"))
        order.fee = None  # TODO:
